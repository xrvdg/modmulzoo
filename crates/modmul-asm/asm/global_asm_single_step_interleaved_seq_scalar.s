...
//in("x8") in4[0], in("x9") in4[1], in("x10") in4[2], in("x11") in4[3],
//in("x12") in5[0], in("x13") in5[1], in("x14") in5[2], in("x15") in5[3],
...
//lateout("x4") out2[0], lateout("x5") out2[1], lateout("x6") out2[2], lateout("x7") out2[3],
