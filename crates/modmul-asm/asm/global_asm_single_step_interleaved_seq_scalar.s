...
//in("x8") a[0], in("x9") a[1], in("x10") a[2], in("x11") a[3],
//in("x12") b[0], in("x13") b[1], in("x14") b[2], in("x15") b[3],
...
//lateout("x4") out[0], lateout("x5") out[1], lateout("x6") out[2], lateout("x7") out[3],
